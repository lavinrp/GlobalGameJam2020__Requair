...
MoveAction::MoveAction(GB::AnimatedSprite& thingToMove, sf::Vector2f endPoint, std::function<void(GB::AnimatedSprite&)> setup)
    : AnimationAction(thingToMove, setup), m_endPoint(endPoint) {}
